...
def write_doc_2_excel(alphabet):
    ...
    config_list_demo = list(car_config_data_collection.find({"car_model_id": 34756}))
    data_csv = xlwt.Workbook(encoding='utf-8', style_compression=0)

    init_sheet_catalog_map(config_list_demo[0])
    # sheet表单的字典，存放某一品牌的车
    sheet_map = {}
...
def init_mongodb_conn():
    ...
    car_config_collection = processor_db.configs
